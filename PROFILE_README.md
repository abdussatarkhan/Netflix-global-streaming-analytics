...
| :--- | :--- | :--- |
| 🎬 **[Netflix Streaming Intelligence & Personalization Platform](https://github.com/abdussatarkhan/Netflix-global-streaming-analytics)** | End-to-end 4-tier streaming platform with dense vector search (`pgvector` HNSW), hybrid recommender, and **[interactive live dashboard](https://github.com/abdussatarkhan/Netflix-global-streaming-analytics/blob/main/stream_iq_insights.html)**. | `Python`, `FastAPI`, `PostgreSQL 16`, `pgvector`, `SentenceTransformers`, `D3.js`, `Docker` |
| 💳 **[FinFlow: Global FinTech Payment Analytics](https://github.com/abdussatarkhan/FinFlow-Global-Fintech-Analytics)** | Enterprise FinTech warehouse: 10-table Star Schema, cross-border corridor profitability, FX spread arbitrage, 24M cohort retention, and synthetic multi-currency telemetry engine. | `Python`, `SQL (PostgreSQL)`, `Pandas`, `Matplotlib/Seaborn`, `Pytest`, `GitHub Actions` |
| 🛒 **[RetailPulse: Omnichannel E-Commerce Analytics](https://github.com/abdussatarkhan/RetailPulse-Omnichannel-ECommerce-Analytics)** | Multi-channel retail intelligence warehouse tracking $139M+ GMV, 3D RFM customer segmentation, 48-hr warehouse fulfillment SLA compliance, and conversion funnels. | `Python`, `SQL (PostgreSQL)`, `Pandas`, `Matplotlib/Seaborn`, `Pytest`, `GitHub Actions` |
| 📈 **[SaaSMetrics: Subscription & Revenue Analytics](https://github.com/abdussatarkhan/SaaSMetrics-Subscription-Revenue-Analytics)** | B2B SaaS executive metrics data warehouse tracking ARR/MRR waterfall bridges, cohort Net Revenue Retention (134%–142% NRR), CAC payback, and sales velocity. | `Python`, `SQL (PostgreSQL)`, `Pandas`, `Matplotlib/Seaborn`, `Pytest`, `GitHub Actions` |
| 📊 **[StreamIQ Insights Dashboard Suite](https://github.com/abdussatarkhan/Netflix-global-streaming-analytics)** | Dual standalone executive analytics suite (`stream_iq_insights.html` & `netflix_dashboard.html`) with real-time AI vector query simulator, 24M cohort heatmaps, and content ROI matrix. | `Chart.js`, `D3.js`, `HTML5/CSS3 Glassmorphism`, `JavaScript` |
